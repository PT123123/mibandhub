...
> **我们的 App 从不发 `ack`**（`ActivitySync` 注释里明确写了，见 [ActivitySync.kt](https://github.com/PT123123/mibandhub/blob/main/app/src/main/java/com/ted/shouhuan/proto/ActivitySync.kt#L49-L54)）。
